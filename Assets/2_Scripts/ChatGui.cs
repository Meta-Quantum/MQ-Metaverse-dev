...
using Photon.Pun;
    ...
    {
        //kind of a hack to get the chatGUi to not duplicate when its made to not destroy on load
        //set to false by default, set to true in editor
        [SerializeField]
        public bool isValidChatGui = false;
