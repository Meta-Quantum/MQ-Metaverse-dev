...
public class SelectPlaceObjectsUI : MonoBehaviour {
    ...
    private void Update() {
        if (Input.GetKeyDown(KeyCode.Alpha1)) HouseBuildingSystem.Instance.SelectPlacedObjectTypeSO(HouseBuildingSystemAssets.Instance.floor);
        if (Input.GetKeyDown(KeyCode.Alpha2)) HouseBuildingSystem.Instance.SelectFloorEdgeObjectTypeSO(HouseBuildingSystemAssets.Instance.wall);
        if (Input.GetKeyDown(KeyCode.Alpha3)) HouseBuildingSystem.Instance.SelectFloorEdgeObjectTypeSO(HouseBuildingSystemAssets.Instance.door);
        if (Input.GetKeyDown(KeyCode.Alpha4)) HouseBuildingSystem.Instance.SelectFloorEdgeObjectTypeSO(HouseBuildingSystemAssets.Instance.wallWindow);
        if (Input.GetKeyDown(KeyCode.Alpha5)) HouseBuildingSystem.Instance.SelectFloorEdgeObjectTypeSO(HouseBuildingSystemAssets.Instance.stairs);
    }
