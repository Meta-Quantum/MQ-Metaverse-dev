...
namespace CodeMonkey.CraftingSystem {
    ...
    public class CharacterEquipment : MonoBehaviour, IItemHolder {
        ...
        private MonkeyPlayer _monkeyPlayer;
        ...
        private void Awake() {
            _monkeyPlayer = GetComponent<MonkeyPlayer>();
        }
        ...
        private void SetWeaponItem(Item weaponItem) {
            ...
            if (weaponItem != null) {
                ...
                _monkeyPlayer.SetEquipment(weaponItem.itemScriptableObject);
            } else {
                // Unequipped weapon
                _monkeyPlayer.SetEquipment(Item.ItemType.SwordNone);
            }
        ...
        private void SetHelmetItem(Item helmetItem) {
            ...
            if (helmetItem != null) {
                ...
                _monkeyPlayer.SetEquipment(helmetItem.itemScriptableObject);
            } else {
                // Unequipped Helmet
                _monkeyPlayer.SetEquipment(Item.ItemType.HelmetNone);
            }
            OnEquipmentChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        private void SetArmorItem(Item armorItem) {
            ...
            if (armorItem != null) {
                ...
                _monkeyPlayer.SetEquipment(armorItem.itemScriptableObject);
            } else {
                // Unequipped Armor
                _monkeyPlayer.SetEquipment(Item.ItemType.ArmorNone);
            }
            OnEquipmentChanged?.Invoke(this, EventArgs.Empty);
        }
